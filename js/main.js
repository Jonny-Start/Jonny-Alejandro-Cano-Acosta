jQuery(document).ready(function($) {
    ...
    var myDoughnut = new Chart(document.getElementById("prestasShop").getContext("2d")).Doughnut(doughnutData);
    ...
    var myDoughnut = new Chart(document.getElementById("templateEngine").getContext("2d")).Doughnut(doughnutData);
